...
import com.ncusoft.ncudocmsapp.activitys.teacher.TeacherEditTeaCouActivity;
import com.ncusoft.ncudocmsapp.activitys.teacher.TeacherStuListActivity;
...
public class StudentCourseActivity extends BaseActivity {
    ...
    public static final String TAG="student.TCActivity";
...
//        studentCourseDao.insert(cvSc4);
        ...
        tcAdapter=new TeacherCourseAdapter(StudentCourseActivity.this,list);
    ...
    public boolean onContextItemSelected(MenuItem item){
        switch (item.getItemId()){
            case 0: //点击查看学生
                ...
                intent.setClass(StudentCourseActivity.this,TeacherStuListActivity.class);
            ...
            case 2: //点击编辑课程
                ...
                intent1.setClass(StudentCourseActivity.this,TeacherEditTeaCouActivity.class);
            ...
            case 3: //点击删除课程
                //可以设置三个按钮
                AlertDialog dlg
                        =new AlertDialog.Builder(StudentCourseActivity.this)
                        ...
                        .setPositiveButton("确定删除", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                if (0==courseService.deleteTeacherCourse(tcList)){
                                    ToastUtil.initToast(StudentCourseActivity.this,
